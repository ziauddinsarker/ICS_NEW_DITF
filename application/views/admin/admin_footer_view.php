    ...
    <script src="<?php echo base_url("assets/dist/js/app.min.js")?> "></script>
      ...
      <script>
          ...
          var multiple = ["1|WPLB-00001-15|1050|",
              ...
              "3|WPLB-00023-15|600|",
              "4|WPLB-00029-15|1500|",
              "5|SLSHB-00078-15|3000|",
              "6|SLSHB-00079-15|1800|",
              "7|WPBP-00072-15|1050|",
              "8|WPLB-00001-15|1050|",
              "9|WPLB-00002-15|1400|",
          ];
...
/*
        function addnewrow(){
            ...
            var tr = '<tr>'+
                '<td class="no">' + n + '</td>'+
                '<td colspan="4"><input type="text" class="form-control productcode autocomplete_txt" data-type="productcode" id="productcode_'+i+'" name="productcode[]" required="required"></td>' +
                '<td><input type="text" class="form-control quantity" data-type="quantity" id='quantity_"+i+"' name="quantity[]" required="required"></td>'+
                '<td><input type="text" class="form-control price autocomplete_txt" data-type="price" id='price_"+i+"' name="price[]" required="required"></td>'+
                '<td><input type="text" class="form-control discount-amount" data-type="discountamount" id='discountamount_"+i+"' name="discountamount[]"></td>'+
                '<td><input type="text" class="form-control discount" data-type="discount" id='discount_"+i+"' name="discount[]"></td>'+
                '<td><input type="text" class="form-control amount" data-type="amount" id='amount_"+i+"' name="amount[]" readonly="readonly"></td>'+
...
/*
        ...
        $(".addmore").on('click',function(){
            ...
            data+="<td><input type="text" class="form-control discount" data-type="discount" id='discount_"+i+"' name="discount[]"></td>";
            data+="<td><input type="text" class="form-control amount" data-type="amount" id='amount_"+i+"' name="amount[]" readonly="readonly"></td>";
            data+="<td><a href="#" class="btn btn-primary remove"><i class="fa fa-times"></i></a></td>";
            $('table').append(data);
            row = i ;
            i++;
        });
